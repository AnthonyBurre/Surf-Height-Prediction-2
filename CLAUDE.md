...
- **Skill score is always measured vs. `PersistenceForecaster`.** Persistence is tough to beat; seasonal-naive and climatology trail it and exist only as diagnostic floors.
